...
Page({
  ...
  //点击薪资
  click_money: function () {
    var selectmoney = this.data.selectmoney;
    if (selectmoney == true) {
      this.setData({
        selectAnother: true,
        select_money: true,
  ...
  //点击规模
  click_scale: function () {
    var selectscale = this.data.selectscale;
    if (selectscale == true) {
      this.setData({
        selectAnother: true,
        select_scale: true,
  ...
  //点击融资
  click_cost: function () {
    var selectcost = this.data.selectcost;
    if (selectcost == true) {
      this.setData({
        selectAnother: true,
        select_cost: true,
  ...
  click_any:function(){
    ...
    var obj = this.data.json.result;
    for (var i = 0; i < obj.length; i++) {
      if (obj[i].ageLimit != "不限") {
        obj.splice(i, 1);
        obj.length -= 1;
        i--;
      }
